...
public final class image_metadata_t implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(sensors.image_metadata_t.class))
            return 0L;
 
        classes.add(sensors.image_metadata_t.class);
    ...
    public static sensors.image_metadata_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        sensors.image_metadata_t o = new sensors.image_metadata_t();
    ...
    public sensors.image_metadata_t copy()
    {
        sensors.image_metadata_t outobj = new sensors.image_metadata_t();
        outobj.key = this.key;
