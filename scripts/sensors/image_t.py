...
import sensors.image_metadata_t
...
class image_t(object):
    ...
    def _encode_one(self, buf):
        ...
        for i0 in range(self.nmetadata):
            assert self.metadata[i0]._get_packed_fingerprint() == sensors.image_metadata_t._get_packed_fingerprint()
    ...
    def _decode_one(buf):
        ...
        self.metadata = []
        for i0 in range(self.nmetadata):
            self.metadata.append(sensors.image_metadata_t._decode_one(buf))
        return self
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0x6fee6cb20472ff6a+ sensors.image_metadata_t._get_hash_recursive(newparents)) & 0xffffffffffffffff
